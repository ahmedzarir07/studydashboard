      ...
      <div className="relative overflow-hidden">
        ...
        <main className="px-4 py-6 max-w-4xl mx-auto">
          ...
          <div className="mb-8">
            ...
            <div className="flex gap-3 overflow-x-auto scrollbar-hide scroll-smooth-touch snap-x snap-mandatory touch-pan-x overscroll-x-contain pb-2 -mx-4 px-4 md:mx-0 md:px-0 md:grid md:grid-cols-3 lg:grid-cols-5 md:overflow-visible">
              <TooltipProvider>
